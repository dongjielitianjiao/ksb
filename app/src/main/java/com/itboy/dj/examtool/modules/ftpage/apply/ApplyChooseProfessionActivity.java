...
/*报名选择职业*/
public class ApplyChooseProfessionActivity extends BaseActivity {
    @BindView(R.id.back)
    RelativeLayout back;
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_apply_choose_profession;
    }
    ...
    protected void initViews() {
        ...
        final String token = (String) SharedPreferencesUtils.getParam(ApplyChooseProfessionActivity.this, "Token", "");
        RetrofitService.getPrfessional("",token)
                ...
                .subscribe(new RxSubscribe<List<ProfessionalBean.DataBean>>(ApplyChooseProfessionActivity.this) {
                    @Override
                    protected void _onNext(final List<ProfessionalBean.DataBean> dataBeen) {
                        ...
                        try {
                            ...
                            firstProfess.setAdapter(new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, firstProBeens) {
                                @Override
                        ...
                        try {
                            ...
                            secondProfess.setAdapter(new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, secondProBeens) {
                                @Override
                                protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                    viewHolder.setText(R.id.sales_tx, item.getName());
                                }
                        ...
                        try {
                            ...
                            thirdProfess.setAdapter(new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, threeProBeens) {
                                @Override
                                protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                    viewHolder.setText(R.id.sales_tx, item.getName());
                                }
                        ...
                        try {
                            ...
                            fourProfess.setAdapter(new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, fourProBeens) {
                                @Override
                                protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                    viewHolder.setText(R.id.sales_tx, item.getName());
                                }
                        ...
                        firstProfess.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                CommonAdapter<FirstProBean> secondAdapter = new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, secondProBeens) {
                                    @Override
                                    protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                        viewHolder.setText(R.id.sales_tx, item.getName());
                                    }
                                ...
                                if (secondProBeens.size() == 1 && "暂无数据".equals(secondProBeens.get(0).getName())) {
                                    ...
                                    fourName = "暂无数据";
                                    fourId = 0 + "";
                                    thirdProfess.setAdapter(new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, secondProBeens) {
                                        @Override
                                        protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                            viewHolder.setText(R.id.sales_tx, item.getName());
                                        }
                                    ...
                                    thirdProfess.setItemChecked(0, true);
                                    fourProfess.setAdapter(new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, secondProBeens) {
                                        @Override
                                        protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                            viewHolder.setText(R.id.sales_tx, item.getName());
                                        }
                                ...
                                try {
                                    ...
                                    CommonAdapter threeAdapter = new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, threeBens) {
                                        @Override
                                        protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                            viewHolder.setText(R.id.sales_tx, item.getName());
                                        }
                                ...
                                if (threeBens.size() == 1 && "暂无数据".equals(threeBens.get(0).getName())) {///
                                    ...
                                    fourName = "暂无数据";
                                    fourId = 0 + "";
                                    fourProfess.setAdapter(new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, threeBens) {///
                                        @Override
                                        protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                            viewHolder.setText(R.id.sales_tx, item.getName());
                                        }
                                ...
                                try {
                                    ...
                                    CommonAdapter fourAdapter = new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, fourBens) {///4
                                        @Override
                                        protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                            viewHolder.setText(R.id.sales_tx, item.getName());
                                        }
                        ...
                        secondProfess.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                               ...
                               /* List<FirstProBean> three1Bens = new ArrayList<FirstProBean>();
                                ...
                                CommonAdapter<FirstProBean> thadapter = new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, threeBens) {//-
                                    @Override
                                    protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                        viewHolder.setText(R.id.sales_tx, item.getName());
                                    }
                               ...
                               /*     List<FirstProBean> four11Bens = new ArrayList<FirstProBean>();
                                    ...
                                    CommonAdapter<FirstProBean> fuadapter = new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, fourBens) {
                                        @Override
                                        protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                            viewHolder.setText(R.id.sales_tx, item.getName());
                                        }
                        ...
                        thirdProfess.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                CommonAdapter<FirstProBean> lastfuadapter = new CommonAdapter<FirstProBean>(ApplyChooseProfessionActivity.this, R.layout.item_first_profe, fourBens) {///0
                                    @Override
                                    protected void convert(ViewHolder viewHolder, FirstProBean item, int position) {
                                        viewHolder.setText(R.id.sales_tx, item.getName());
                                    }
  ...
  /*      RetrofitService.getPrfessional("", token)
                .compose(this.<ProfessionalBean>bindToLife())
                .observeOn(Schedulers.io())
                .flatMap(new Func1<ProfessionalBean, Observable<ProfessionalBean.DataBean>>() {
                    @Override
                    public Observable<ProfessionalBean.DataBean> call(ProfessionalBean professionalBean) {
                ...
                .toList()
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<List<ProfessionalBean.DataBean>>() {
                    @Override
                    ...
                    @Override
                    public void onNext(final List<ProfessionalBean.DataBean> dataBeen) {
    ...
    protected void updateViews(boolean isRefresh) {
        applyNextOne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ApplyChooseProfessionActivity.this, KaoPeiFixActivity.class);
                intent.putExtra("fistArr", (Serializable) firstProBeens);
                intent.putExtra("secArr", (Serializable) secondProBeens);
                intent.putExtra("threeArr", (Serializable) threeBens);
                intent.putExtra("fourArr", (Serializable) fourBens);
