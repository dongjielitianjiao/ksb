...
public class ApplyingCfFragment extends BaseFragment {

    @BindView(R.id.applying_rec)
    RecyclerView ApplyingRec;
    ...
    protected int attachLayoutRes() {
        return R.layout.fragment_to_applying;
    }
    ...
    protected void initViews() {
        ...
        ApplyingRec.setLayoutManager(new LinearLayoutManager(getActivity()));
        ApplyingRec.addItemDecoration(new RecycleViewDivider(mContext, LinearLayoutManager.HORIZONTAL, R.drawable.recycle_divider));


        final String token = (String) SharedPreferencesUtils.getParam(getActivity(), "Token", "");
        RetrofitService.getAllCf("auditing",token).subscribe(new Subscriber<CfBean>() {
            @Override
            ...
            public void onNext(CfBean cfBean) {
                Log.d("ApplyingCfFragment", cfBean.toString());
