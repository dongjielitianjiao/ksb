...
public abstract class BaseFragment<T extends IBasePresenter> extends RxFragment implements IBaseView {
    ...
    public void showLoading() {
        if (mEmptyLayout != null) {
            ...
            SwipeRefreshHelper.enableRefresh(mSwipeRefresh, false);//2
        }
    }
    ...
    public void hideLoading() {
        if (mEmptyLayout != null) {
            mEmptyLayout.hide();
            SwipeRefreshHelper.enableRefresh(mSwipeRefresh, true);//控制下拉刷新的开关
            SwipeRefreshHelper.controlRefresh(mSwipeRefresh, false); //加载完后关闭
        }
    }
    ...
    protected ApplicationComponent getAppComponent() {
        ApplicationComponent appComponent = BaseApplication.getAppComponent();
