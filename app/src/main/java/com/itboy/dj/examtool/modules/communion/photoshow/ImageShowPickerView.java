package com.itboy.dj.examtool.modules.communion.photoshow;
...
public class ImageShowPickerView extends LinearLayout {
    ...
    private void viewTypedArray(Context context, AttributeSet attrs) {
        ...
        mAddLabel = typedArray.getResourceId(R.styleable.ImageShowPickerView_add_label, R.mipmap.j_ic_xiangji);
