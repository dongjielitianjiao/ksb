 ...
 */
public class MegagameAdapter extends BaseAdapter {
  ...
  */
    public MegagameAdapter(FragmentManager fragmentManager, Fragment[] fragmentArray, String[] itemNames) {
        this.fragmentArray = fragmentArray;
        this.fragmentManager = fragmentManager;
    ...
    public int[] getIconImageArray() {
        return new int[]{R.drawable.base_line_normal, R.drawable.base_line_normal};
    }

    //#E7B670
    @Override
    public int[] getSelectedIconImageArray() {
        return new int[]{R.drawable.base_line_select_yellow, R.drawable.base_line_select_yellow};
    }
